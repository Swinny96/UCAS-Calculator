...
import Courses from "./UCAS-Courses";
import Grades from "./UCAS-Grades";
...
export default class MyUCASCalculator extends Component {
  state = {
    rows: [{}],
    dataValue: "int",
    value: "",
  ...
  async componentDidMount() {
    ...
    const list = "https://www.ucas.com/api/tariff/v1/list";
    const view = "https://www.ucas.com/api/tariff/v1/view";
